...
class FriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend" do
    assert_difference('Friend.count') do
      post friends_url, params: { friend: { mail: @friend.mail, name: @friend.name, phone: @friend.phone } }
    end
  ...
  test "should update friend" do
    patch friend_url(@friend), params: { friend: { mail: @friend.mail, name: @friend.name, phone: @friend.phone } }
